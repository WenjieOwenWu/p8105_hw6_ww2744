...
``` r
ggplot(city_glm_results, aes(x = city_state, y = estimate, ymin = conf.low, ymax = conf.high)) +
  geom_pointrange() +
  coord_flip() +
...
![](p8105_hw6_ww2744_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](p8105_hw6_ww2744_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> -
